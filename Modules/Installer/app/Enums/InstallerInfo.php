...
enum InstallerInfo: string
{
    ...
    case VERIFICATION_URL = 'https://pcv.elixone.com/api/v1/validate';
    case VERIFICATION_HASHED_URL = 'https://pcv.elixone.com/api/v1/validate/code';
    case UPDATE_CHECK_URL = 'https://pcv.elixone.com/api/v1/updateable';
