...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::controller(DashboardController::class)->group(function () {
        ...
        // Route::get('orders', 'orders'); // Removed - system is now free
        // Route::get('orders/{invoice_id}', 'show_order')->where('invoice_id', '[a-zA-Z0-9-_]+'); // Removed - system is now free
...
Route::middleware('payment.api')->group(function () {
    // Route::get('download-invoice/{invoice_id}', [DashboardController::class,'downloadInvoice'])->where('invoice_id', '[a-zA-Z0-9-_]+')->withoutMiddleware('json.only'); // Removed - system is now free
