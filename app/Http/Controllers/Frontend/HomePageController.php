...
// SectionSetting dependency removed - using database query directly
...
class HomePageController extends Controller {
    ...
    function index(): View {
        // Always use the main template since other templates have been removed
        $theme_name = 'main';
        ...
        // Get section settings directly from database since SiteAppearance module is removed
        $sectionSetting = (object) DB::table('section_settings')->first();
    ...
    function changeTheme(string $theme) {
        // Theme switching is no longer supported since only main template exists
        abort(404);
    }
}
