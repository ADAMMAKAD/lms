...
class InstructorCourseController extends Controller {
    ...
    public function edit(Request $request) {
        ...
        case '4':
            ...
            // Get all students who have made progress on this course (free system)
            ...
            $total_enrollments = $students_with_progress->count(); // Now represents students with progress
