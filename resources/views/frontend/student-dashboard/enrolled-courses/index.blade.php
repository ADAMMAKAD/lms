                                    ...
                                    <div class="dashboard-courses-active dashboard_courses">
                                        <div class="courses__item courses__item-two shine__animate-item">
                                            <div class="row align-items-center">
                                                ...
                                                <a
                                                    href="javascript:;">{{ $enroll->course->category->translation->name ?? $enroll->course->category->name ?? 'Uncategorized' }}</a>
                                            </li>
                                                        </ul>
                                                ...
                                                <a href="javascript:;"><img
                                                        src="{{ asset($enroll->course->instructor->image ?? 'default-avatar.png') }}"
                                                        alt="img">{{ $enroll->course->instructor->name ?? 'Unknown Instructor' }}</a>
                                            </div>
                                                    ...
                                                    <div class="courses__item-bottom-two">
                                                        <ul class="list-wrap">
                                                            ...
                                                            <li><i
                                                    class="flaticon-mortarboard"></i>{{ $enroll->course->progresses()->distinct('user_id')->count() }}
                                            </li>
