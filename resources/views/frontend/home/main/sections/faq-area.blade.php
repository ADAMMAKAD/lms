      ...
      <div class="row align-items-center">
          <div class="col-lg-6">
              <div class="faq__img-wrap" style="position: relative; padding: 40px; text-align: center;">
                  ...
                  <div style="background: linear-gradient(135deg, #1e40af, #3b82f6); border-radius: 30px; padding: 60px 40px; box-shadow: 0 20px 60px rgba(30, 64, 175, 0.3); position: relative; overflow: hidden;">
                      <!-- Background Elements -->
          ...
          <div class="col-lg-6">
              <div class="faq__content" style="padding-left: 40px;">
                  <div class="section__title" style="margin-bottom: 30px;">
                      <span style="background: linear-gradient(135deg, #1e40af, #3b82f6); color: white; padding: 8px 20px; border-radius: 25px; font-size: 0.9rem; font-weight: 600; letter-spacing: 0.5px; display: inline-block; margin-bottom: 20px; box-shadow: 0 4px 15px rgba(30, 64, 175, 0.3);">{{ $faqSection?->content?->short_title ?: 'FAQ' }}</span>
                      <h2 style="font-size: 2.5rem; color: #1E293B; line-height: 1.2; margin: 0; font-family: 'Inter', sans-serif; font-weight: 700;">
                          <span style="background: linear-gradient(135deg, #1e40af, #3b82f6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">{!! clean(processText($faqSection?->content?->title)) ?: 'Common Questions' !!}</span>
                      </h2>
                  </div>
                          ...
                          <div class="accordion-item" style="background: white; border: none; border-radius: 16px; margin-bottom: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 8px 30px rgba(30, 64, 175, 0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(0, 0, 0, 0.08)';">
                              <h2 class="accordion-header" style="border: none;">
                                  <button class="accordion-button {{ $loop->first ? '' : 'collapsed' }}" type="button" data-bs-toggle="collapse"
                                      ...
                                      {{ $faq?->question }}
                                      <span style="margin-left: auto; width: 24px; height: 24px; background: linear-gradient(135deg, #1e40af, #3b82f6); border-radius: 50%; display: flex; align-items: center; justify-content: center; transition: transform 0.3s ease;">
