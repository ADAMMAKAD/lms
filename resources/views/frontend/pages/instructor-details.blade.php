...
@section('contents')
    <!-- breadcrumb-area -->
    <x-frontend.breadcrumb :title="__('Instructor Details')" :subtitle="__('Learn more about our expert instructor and their qualifications')" :links="[['url' => route('home'), 'text' => __('Home')], ['url' => '', 'text' => __('Instructor Details')]]" />
    <!-- breadcrumb-area-end -->
                                ...
                                <div class="badges">
                                    ...
                                    @php
                                        ...
                                        foreach ($instructor->courses as $course) {
                                            $totalEnrollment += $course->enrollments ? $course->enrollments->count() : 0;
                                        }
                                    @endphp
                                            ...
                                            <i class="{{ $course?->favorite_by_client ? 'fas' : 'far' }} fa-heart"></i>
                                                    ...
                                                    <div class="courses__item-content">
                                                        ...
                                                        <div class="courses__item-bottom">
                                                            ...
                                                            @elseif ($course->enrollments && $course->enrollments->count() >= $course->capacity && $course->capacity != null)
                                                                <div class="button">
