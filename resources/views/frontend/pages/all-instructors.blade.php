...
@section('contents')
    <!-- breadcrumb-area -->
    <x-frontend.breadcrumb :title="__('All Instructors')" :subtitle="__('Meet our expert instructors and discover their expertise')" :links="[['url' => route('home'), 'text' => __('Home')], ['url' => '', 'text' => __('All Instructors')]]" />
    <!-- breadcrumb-area-end -->
    <!-- instructor-area -->
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="instructor__item">
                                <div class="instructor__thumb">
                                    ...
                                    <a
                                        href="{{ route('instructor-details', ['id' => $instructor->id, 'slug' => \Illuminate\Support\Str::slug($instructor->name)]) }}"><img
