...
@section('contents')
    <!-- breadcrumb-area -->
    <x-frontend.breadcrumb :title="__('Register')" :subtitle="__('Create your account and start your learning adventure today')" :links="[['url' => route('home'), 'text' => __('Home')], ['url' => route('register'), 'text' => __('Register')]]" />
    <!-- breadcrumb-area-end -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-7 col-md-8">
                    <div class="singUp-wrap modern-register-card" style="background: #fff; border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.1); padding: 3rem; border: none; position: relative; overflow: hidden;">
                        ...
                        <h2 class="title" style="color: #333; font-weight: 700; font-size: 1.8rem; margin-bottom: 0.5rem; text-align: center;">{{ __('Join UNDP LMS') }}</h2>
                        <p style="color: #666; text-align: center; margin-bottom: 2rem; font-size: 1rem;">{{ __('Start your sustainable development learning journey today') }}
                        </p>
                        ...
                        @endif
                        <form method="POST" action="{{ route('register') }}" class="account__form modern-form">
                            @csrf
                            
                            <div class="form-grp modern-form-group" style="margin-bottom: 1.5rem;">
                                <label for="fast-name" style="color: #333; font-weight: 600; margin-bottom: 0.5rem; display: block; font-size: 0.9rem;">{{ __('Full Name') }} <span style="color: #e74c3c;">*</span></label>
                                <input type="text" id="fast-name" placeholder="Enter your full name" name="name" style="width: 100%; padding: 1rem; border: 2px solid #e9ecef; border-radius: 12px; font-size: 1rem; transition: all 0.3s ease; background: #f8f9fa;" onfocus="this.style.borderColor='#0066cc'; this.style.background='#fff'; this.style.boxShadow='0 0 0 3px rgba(0,102,204,0.1)'" onblur="this.style.borderColor='#e9ecef'; this.style.background='#f8f9fa'; this.style.boxShadow='none'">
                            ...
                            <div class="form-grp modern-form-group" style="margin-bottom: 1.5rem;">
                                ...
                                <input type="email" id="email" placeholder="Enter your email address" name="email" style="width: 100%; padding: 1rem; border: 2px solid #e9ecef; border-radius: 12px; font-size: 1rem; transition: all 0.3s ease; background: #f8f9fa;" onfocus="this.style.borderColor='#0066cc'; this.style.background='#fff'; this.style.boxShadow='0 0 0 3px rgba(0,102,204,0.1)'" onblur="this.style.borderColor='#e9ecef'; this.style.background='#f8f9fa'; this.style.boxShadow='none'">
                            ...
                            <div class="form-grp modern-form-group" style="margin-bottom: 1.5rem;">
                                ...
                                <input type="password" id="password" placeholder="Create a strong password" name="password" style="width: 100%; padding: 1rem; border: 2px solid #e9ecef; border-radius: 12px; font-size: 1rem; transition: all 0.3s ease; background: #f8f9fa;" onfocus="this.style.borderColor='#0066cc'; this.style.background='#fff'; this.style.boxShadow='0 0 0 3px rgba(0,102,204,0.1)'" onblur="this.style.borderColor='#e9ecef'; this.style.background='#f8f9fa'; this.style.boxShadow='none'">
                                <x-frontend.validation-error name="password" />
                            </div>
                            
                            <div class="form-grp modern-form-group" style="margin-bottom: 1.5rem;">
                                <label for="confirm-password" style="color: #333; font-weight: 600; margin-bottom: 0.5rem; display: block; font-size: 0.9rem;">{{ __('Confirm Password') }} <span style="color: #e74c3c;">*</span></label>
                                <input type="password" id="confirm-password" placeholder="Confirm your password" name="password_confirmation" style="width: 100%; padding: 1rem; border: 2px solid #e9ecef; border-radius: 12px; font-size: 1rem; transition: all 0.3s ease; background: #f8f9fa;" onfocus="this.style.borderColor='#0066cc'; this.style.background='#fff'; this.style.boxShadow='0 0 0 3px rgba(0,102,204,0.1)'" onblur="this.style.borderColor='#e9ecef'; this.style.background='#f8f9fa'; this.style.boxShadow='none'">
